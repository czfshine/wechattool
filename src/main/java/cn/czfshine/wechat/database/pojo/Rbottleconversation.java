...
public class Rbottleconversation {
  ...
  private long unReadInvite;
  private String firstUnDeliverSeq;
  ...
  public long getUnReadInvite() {
    return unReadInvite;
  }

  public void setUnReadInvite(long unReadInvite) {
    this.unReadInvite = unReadInvite;
  }


  public String getFirstUnDeliverSeq() {
    return firstUnDeliverSeq;
  }

  public void setFirstUnDeliverSeq(String firstUnDeliverSeq) {
    this.firstUnDeliverSeq = firstUnDeliverSeq;
  }
