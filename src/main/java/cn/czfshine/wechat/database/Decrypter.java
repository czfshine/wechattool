...
public class Decrypter {
    ...
    public static void decryptDataBase(String encryptpath, String imei, String uin, String outputpath) {

        String key = getKey(imei,uin);
        System.out.println(key);

         try (Statement statement = DriverManager.getConnection("jdbc:sqlite:" + encryptpath).createStatement()) {
             System.out.println(
